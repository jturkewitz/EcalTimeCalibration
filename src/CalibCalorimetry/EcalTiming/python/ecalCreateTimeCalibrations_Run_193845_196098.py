...
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string("/local/cms/user/turkewitz/EcalTiming/EcalCreateTimeCalibs/ecalCreateTimeCalibs_Runs_195000-196098.root"),
...
process.createTimeCalibs = cms.EDAnalyzer("EcalCreateTimeCalibrations",
  ...
  RunIncludeExclude = cms.string("195000-196098"),
  ...
  InputFileNames = cms.vstring('file:/local/cms/user/turkewitz/EcalTiming/ElectronHadTrees/rh-ElectronHad_ElectronHad_Run2012B-PromptReco-v1_AOD-193845-196098.HADDED.root')
)
