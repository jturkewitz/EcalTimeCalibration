...
lcg_RelationalAccess_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/RelationalAccess/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_OracleAccess_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/OracleAccess/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_XMLAuthenticationService_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/XMLAuthenticationService/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_CoralCommon_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/CoralCommon/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_RelationalService_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/RelationalService/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_MonitoringService_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/MonitoringService/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_SQLiteAccess_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/SQLiteAccess/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
PyCoral := lcg_PyCoral
lcg_PyCoral_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/PyCoral/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_CoralBase_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/CoralBase/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_ConnectionService_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/ConnectionService/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_EnvironmentAuthenticationService_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/EnvironmentAuthenticationService/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_FrontierAccess_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/FrontierAccess/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_XMLLookupService_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/XMLLookupService/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
...
lcg_CoralKernel_BuildFile    := $(wildcard $(WORKINGDIR)/cache/bf/src/LCG/CoralKernel/BuildFile) /local/cms/sw/slc5_amd64_gcc462/cms/coral/CORAL_2_3_21-cms2/.SCRAM/$(SCRAM_ARCH)/MakeData/DirCache.mk
